...
os.system(f'title Windows Multirepair Tool │ by طارق#0027 ')
while True:
    os.system("cls")
    print(f"""
    {OKBLUE}
                                    ...
                                    ╚███╔███╔╝██║██║ ╚████║██████╔╝╚██████╔╝╚███╔███╔╝███████║
                                     ╚══╝╚══╝ ╚═╝╚═╝  ╚═══╝╚═════╝  ╚═════╝  ╚══╝╚══╝ ╚══════╝
                                             ...
                                             {OKBLUE}│{Reset} [4] Activate Win10 Pro                 {OKBLUE}│{Reset}
                                             {OKBLUE}│{Reset} [5] Activate Win10 Pro Enterprise      {OKBLUE}│{Reset}
...
""")
    ...
    if Input == "1":
        os.system("cls")
        print(f"{Valid} Cleaning Computer")
        time.sleep(1)
    ...
    if Input == "5":
        os.system("cls")
        print(f"{Valid} Activate Windows 10 Pro Enterprise")
        time.sleep(1)
    ...
    if Input == "8":
        ...
        time.sleep(1)
        webbrowser.open("https://discord.gg/gv4TQTCneb")
